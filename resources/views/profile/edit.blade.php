...
<div class="admin-shell">
  <div class="admin-inner" style="max-width:520px;">
    ...
    <p class="page-sub">修改自己的姓名和登录密码</p>
    ...
    <form method="POST" action="{{ route('profile.update') }}" style="background:var(--card);border:1px solid var(--border);border-radius:12px;padding:20px;">
      ...
      <p class="hint" style="margin:0 0 12px;">如需修改密码，填写下面三项；不改密码可以留空。</p>
      <div class="field">
        <label>当前密码</label>
      ...
      <button type="submit" class="btn btn-accent" style="width:100%;justify-content:center;margin-top:8px;">保存</button>
    </form>
  </div>
</div>
@endsection
